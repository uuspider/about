...
参考：[UNIX Tutorial for Beginners][ref1]{:target="_blank"}, [Introduction to Linux][ref2]{:target="_blank"}, [Linux command line for you and me][ref3]{:target="_blank"}

[ref1]:http://www.ee.surrey.ac.uk/Teaching/Unix/
[ref2]:http://www.tldp.org/LDP/intro-linux/html/
[ref3]:https://lym.readthedocs.io/en/latest/index.html
