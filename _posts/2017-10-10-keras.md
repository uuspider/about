...
参考：[Keras Documentation][ref1]{:target="_blank"}, [Keras Github][ref6]{:target="_blank"}, [Keras文档][ref2]{:target="_blank"}, [卷积神经网络][ref3]{:target="_blank"}, [机器学习][ref4]{:target="_blank"}, [Images Datasets][ref5]{:target="_blank"}, [Deep Learning Papers][ref7]{:target="_blank"}, [Deep Learning with keras][ref8]{:target="_blank"}
