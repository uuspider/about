...
参考：[Keras Documentation][ref1]{:target="_blank"}, [Keras Github][ref6]{:target="_blank"}, [Keras文档][ref2]{:target="_blank"}, [卷积神经网络][ref3]{:target="_blank"}, [机器学习][ref4]{:target="_blank"}, [Images Datasets][ref5]{:target="_blank"}, [Deep Learning Papers][ref7]{:target="_blank"}
...
为了限制模型的复杂度，抑制过拟合，提高泛化能力，需要对损失函数进行调整和修正，这种处理方法被称为“正则化”(regularization，翻译为正则并不恰当，不入直接称之为调整或修正)，如引入L2惩罚项：
...
![基本循环神经网络](http://upload-images.jianshu.io/upload_images/2256672-479f2a7488b91671.jpg)

\\(x\\)是输入层的值，\\(o\\)是输出层的值，\\(s\\)是隐藏层的值，U是输入层到隐藏层的权重矩阵，V是隐藏层到输出层的权重矩阵，W是隐藏层上一次的值作为这一次的输入的权重矩阵，将该网络在时间维度上展开就得到：

![基本循环神经网络](http://upload-images.jianshu.io/upload_images/2256672-cf18bb1f06e750a4.jpg)
...
![双向循环神经网络](http://upload-images.jianshu.io/upload_images/2256672-039a45251aa5d220.png)
...
![深度循环网络](http://upload-images.jianshu.io/upload_images/2256672-df137de8007c3d26.png?imageMogr2/auto-orient/strip%7CimageView2/2/w/480)
...
![长短时记忆网络](http://upload-images.jianshu.io/upload_images/2256672-715658c134b9d6f1.png?imageMogr2/auto-orient/strip%7CimageView2/2/w/1240)
...
![状态c的控制](http://upload-images.jianshu.io/upload_images/2256672-bff9353b92b9c488.png?imageMogr2/auto-orient/strip%7CimageView2/2/w/1240)

下图是LSTM一个节点的结构图：

![LSTM](http://upload-images.jianshu.io/upload_images/2256672-7ea82e4f1ac6cd75.png?imageMogr2/auto-orient/strip%7CimageView2/2/w/1240)
...
![GRU](http://upload-images.jianshu.io/upload_images/2256672-b784d887bf693253.png?imageMogr2/auto-orient/strip%7CimageView2/2/w/1240)
