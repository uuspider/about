...
更多字符串操作请看[这里](http://about.uuspider.com/2016/04/08/pyre.html#string)。
...
更多文件处理，请看[这里](http://about.uuspider.com/2016/04/08/pyre.html#io)。
...
类可以继承，构成“超类”、“子类”等，类中的方法还可以重写，[这些概念](http://www.pythondoc.com/pythontutorial27/classes.html)的作用需要在写代码过程中理解和领悟。
...
此外，还有相对导入、局部导入等调用模块的方法，请查看[这里](http://www.codingpy.com/article/python-import-101/)。
