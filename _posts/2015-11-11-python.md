...
参考：[Python tutorial][ref1]{:target="_blank"}, [A byte of python][ref2]{:target="_blank"}, [Dive into python][ref3]{:target="_blank"}, [Python Package Index][ref4]{:target="_blank"}, [python style rules][ref5]{:target="_blank"}
