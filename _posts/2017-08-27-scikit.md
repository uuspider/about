...
*   [数据导入](#input)
*   [距离计算](#distance): [Minkowski](#minkowski)\|[Euclidean](#euclidean)\|[Manhattan](#manhattan)\|[cosine](#cosine)\|[Jaccard](#jaccard)\|[Pearson](#pearson)
*   [k近邻](#knn)
*   [贝叶斯分类器](#proxy)
*   [决策树](#timeout)
*   [Logistic回归](#error)
...
余弦距离常常用于文本挖掘，词是轴，文档为向量，两个向量夹角的余弦值代表了这两个文档之间的相似度。
...
与此类似，Pearson系数可以更准确地判断两个向量的相似程度，它反映的是两个向量与某一条直线的拟合程度。
