...
[注意] 数组名代表了数组的首地址。
a的首地址:	0x7ffc6a19e660	a[0]的值:	11
a[1]的地址:	0x7ffc6a19e664	a[1]的值:	12
a[2]的地址:	0x7ffc6a19e668	a[2]的值:	23
a[3]的地址:	0x7ffc6a19e66c	a[3]的值:	34
a[4]的地址:	0x7ffc6a19e670	a[4]的值:	45
数组a占用内存:	20 bytes
定义指针:
	int * p;
为指针赋值:
...
p+0指向的地址:	0x7ffc6a19e660	存储的值:	11
p+1指向的地址:	0x7ffc6a19e664	存储的值:	12
p+2指向的地址:	0x7ffc6a19e668	存储的值:	23
p+3指向的地址:	0x7ffc6a19e66c	存储的值:	34
p+4指向的地址:	0x7ffc6a19e670	存储的值:	45
指针是用于存储地址的变量，指针也有地址:
	&p
指针p的地址:	0x7ffc6a19e658	存储的值:	0x7ffc6a19e660
指针p占用内存:	8 bytes
对a取址:
	&a
a的首地址:	0x7ffc6a19e660	&a:		0x7ffc6a19e660
[注意] a和&a是一样的!
数组a的内存图如下:
	+----------------+
	+              45+
